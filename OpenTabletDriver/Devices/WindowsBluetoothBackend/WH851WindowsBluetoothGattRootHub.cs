...
{
    // Ported from upstream PR #4864 (ooopus/avalonia-wh851-bluetooth-gatt).
    // Enumerates the WH851's FFE0 GATT service directly because Windows does
    // not expose the vendor GATT pen data as a HID device.
